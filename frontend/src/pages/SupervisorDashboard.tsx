													...
													<div className="flex items-center justify-end gap-2">
														<div className="w-20 rounded-full bg-secondary h-2">
															<div
																...
																style={{
																	width: `${Math.min(student.overall_completion_percentage, 100)}%`,
																}}
															/>
														</div>
						...
						<div className="p-6 space-y-6 max-h-[70vh] overflow-y-auto">
							...
							<div className="grid gap-4 md:grid-cols-3">
								<div className="flex items-center justify-center">
									<ProgressGauge
										percentage={selectedStudent.overall_completion_percentage}
										size={150}
									/>
								</div>
								<Card>
									<CardContent className="pt-6">
										<div className="text-2xl font-bold">
											{selectedStudent.total_completed}
										</div>
										<p className="text-sm text-muted-foreground">
											of {selectedStudent.total_required} required
										</p>
									</CardContent>
								</Card>
								<Card>
									<CardContent className="pt-6">
										<div className="text-2xl font-bold">
											{selectedStudent.current_department || "None"}
										</div>
										<p className="text-sm text-muted-foreground">
											Current Rotation
										</p>
							...
							<div className="grid gap-4 lg:grid-cols-2">
								...
								<Card>
									...
									<CardContent>
										<ProgressTimeline
											data={selectedStudent.progress_over_time}
										/>
									</CardContent>
								</Card>
							</div>
							...
							<Card>
								...
								<CardContent className="space-y-2">
									{selectedStudent.departments.map(
