...
import type { AssignmentType, AssignmentWithDetails } from "@/types/assignment";
...
export default function AssignmentManagement() {
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		if (formData.assignment_type === "primary" && !formData.student_id) {
			setAssignmentTypeError(
				"Please select a student for primary assignments.",
			);
		...
		if (formData.assignment_type === "department" && !formData.department_id) {
			setAssignmentTypeError(
				"Please select a department for department assignments.",
			);
			setIsSubmitting(false);
			return;
		}
		...
		try {
			await assignmentService.create({
				...
				student_id:
					formData.assignment_type === "primary" ? formData.student_id : null,
