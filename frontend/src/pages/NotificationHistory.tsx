		...
		<div className="space-y-6">
			<div className="flex items-center justify-between">
				<div>
					...
					<p className="text-muted-foreground">
						{user?.role === "admin"
							? "View all system-generated notifications"
							: "View notifications generated for you"}
					</p>
				</div>
			...
			<Card className="p-6">
				...
				<p className="text-sm text-muted-foreground mb-4">
					Automated notifications generated by the system for events such as submission reviews and profile changes
				</p>
